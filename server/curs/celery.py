...
def setup_periodic_tasks(sender, **kwargs):
    ...
    sender.add_periodic_task(crontab(hour=9, minute=58, day_of_week=2), allsend.s('Рассылка вторник'), name='Рассылка вторник')
    sender.add_periodic_task(crontab(hour=9, minute=58, day_of_week=3), allsend.s('Рассылка среда'), name='Рассылка среда')
    sender.add_periodic_task(crontab(hour=9, minute=58, day_of_week=4), allsend.s('Рассылка четверг'), name='Рассылка четверг')
    sender.add_periodic_task(crontab(hour=9, minute=58, day_of_week=5), allsend.s('Рассылка пятница'), name='Рассылка пятница')
    sender.add_periodic_task(crontab(hour=9, minute=58, day_of_week=6), allsend.s('Рассылка суббота'), name='Рассылка суббота')
